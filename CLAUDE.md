...
Nemotron-3-Nano-4B via NeMo AutoModel (https://github.com/NVIDIA-NeMo/Automodel), served as
GGUF. README.md has commands and results, TRAINING.md the exact recipe, environments and
provenance. Sibling of `../feln-rag`.
...
- Training, checkpoint scoring and export run on the RTX box in
  ...
  checking `tmux ls` and `nvidia-smi`. The 2026-09-14 LoRA, 2026-09-16 QLoRA and both
  2026-09-16 v2 runs are complete: do not restart them.
